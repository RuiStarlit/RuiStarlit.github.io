        ...
        * */
        [
            "player",
            {
                disableSpace: false,
                //网易云单个歌单id
                songIds: ['1934314061','1934314059','193431591'],
                //网易云歌单
                playlist: '5445572269',
                showPlaylist: true,
    ...
    * */
    themeConfig: {
        ...
        * */
        ...
        repo: "https://github.com/RuiStarlit/RuiStarlit.github.io",

        //自定义GitHub的图标
        repoIconClass: 'aurora-navbar-github',

        //md文件的仓库地址
        docsRepo: 'https://github.com/RuiStarlit/RuiStarlit.github.io/blob/main/README.md',
        ...
        * */
        ...
        //页脚信息，支持HTML，这是一个数组
        footer: [
            "This Page created by RuiStarlit",
            "Email: RuiStarlit@foxmail.com",
        ],
        ...
        //网站开始时间，请按照以下格式进行
        startRunTime: "9/4/2022 12:00:00",
        ...
        //首页中间框的话语
        mood: "Et omnia vanitas in tristitia.",
        ...
        //侧边栏配置
        //github地址
        githubUrl: "https://github.com/RuiStarlit",
        ...
        * */
        ...
        //侧边栏一句话描述
        sidebarDesc: '统计学研究生在读。兴趣方向社会学，心理学。@HUST',
